    ...
    <>
      <nav className="navbar">
        ...
        <div className="logo-container">
          ...
          <div className="logo-tooltip">One of Google's most important self professed Core Values "Don't be Evil"
            was part of their brand values since it started. It was quietly removed in 2018. For Tru. Look it up &#40;with us&#41; Compare us vs the rest
          </div>
        </div>
